...
public class DBreadAndExcelCreate {
	...
	public void join() {
		...
		while (true) {
			System.out.println("¾ÆÀÌµğ¸¦ ÀÔ·ÂÇÏ¼¼¿ä.");
			System.out.println("¿µ¹®ÀÚ¿Í ¼ıÀÚ¸¦ Æ÷ÇÔÇÏ¿© 8~12ÀÚ¸®·Î ÀÔ·ÂÇÏ¼¼¿ä. °ø¹éÀº ¾È µË´Ï´Ù.");
			id = sc.nextLine();
		...
		while (true) {
			System.out.println("ºñ¹Ğ¹øÈ£¸¦ ÀÔ·ÂÇÏ¼¼¿ä.");
			System.out.println("¿µ¹®ÀÚ¿Í ¼ıÀÚ¿Í Æ¯¼ö¹®ÀÚ¸¦ Æ÷ÇÔÇÏ¿© 8~12ÀÚ¸®·Î ÀÔ·ÂÇÏ¼¼¿ä. °ø¹éÀº ¾È µË´Ï´Ù.");
